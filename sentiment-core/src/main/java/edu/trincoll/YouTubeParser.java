...
public class YouTubeParser {
  ...
  private static void downloadCaption(String captionId) throws IOException {
    ...
    OutputStream outputFile = new FileOutputStream("captionFile.txt");
  ...
  /*
   * Prompt the user to enter a name for the caption track. Then return the
   * name.
   */
  ...
  public static void main(String[] args) {
    ...
    try {
      ...
      switch (action) {
      case UPLOAD:
        uploadCaption(getVideoId(), getLanguage(), getName(),
            getCaptionFromUser());
        break;
      case LIST:
      ...
      default:
        ...
        // Prompt the user to specify a video to upload the caption track for
        // and
        // a language, a name, a binary file for the caption track. Then upload
        // the
