...
import youtube.src.main.java.YouTubeParser.Action;
...
public class Quickstart {
   ...
   */
  private static final List<String> SCOPES = Lists
  ...
  public static void main(String[] args) throws Exception {
    ...
    try {
      ...
      downloadCaption("TqXDnlamg84o4bX0q2oaHz4nfWZdyiZMOrcuWsSLyPc=");
      // List<String> scopes =
       ...
       * Channel channel = response.getItems().get(0); System.out.printf(
