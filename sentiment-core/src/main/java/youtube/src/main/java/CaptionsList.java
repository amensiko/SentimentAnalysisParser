...
public class CaptionsList {
  ...
  private static final Collection<String> SCOPES = Arrays.asList(
      "YouTubeScopes.https://www.googleapis.com/auth/youtube.force-ssl YouTubeScopes.https://www.googleapis.com/auth/youtubepartner");
  ...
  public static Credential authorize() throws IOException {
    // Load client secrets.
    InputStream in = CaptionsList.class
  ...
  public static void main(String[] args) throws IOException {
    ...
    try {
      ...
      parameters.put("videoId", "qV6wAJVCVus");
      parameters.put("onBehalfOfContentOwner", "");

      YouTube.Captions.List captionsListRequest = youtube.captions().list(
          parameters.get("part").toString(),
          parameters.get("videoId").toString());
      if (parameters.containsKey("onBehalfOfContentOwner")
          && parameters.get("onBehalfOfContentOwner") != "") {
        captionsListRequest.setOnBehalfOfContentOwner(
